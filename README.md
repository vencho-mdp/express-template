...
#### ⚠️ With Nuxt v3 you should be using [`h3`](https://v3.nuxtjs.org/concepts/server-engine) which is already optimized to work with Nuxt (and quite similar to Express).
